...
package object examples {
  ...
  def sumF: Fix[ListF[Int, ?]] => Int =
    cata[Int, ListF[Int, ?]] { case Cons(h, t) => h + t; case NilF => 0 }

  def countF: Fix[ListF[Int, ?]] => Int =
    cata[Int, ListF[Int, ?]] { case Cons(h, t) => 1 + t; case NilF => 0 }

  def genList: Int => Fix[ListF[Int, ?]] =
    ana[ListF[Int, ?], Int] { case 0 => NilF; case n => Cons(n, n - 1) }

  def collapseList: Fix[ListF[Int, ?]] => Int =
    cata[Int, ListF[Int, ?]] { case NilF => 1; case Cons(h, t) => h * t }
  ...
  def cataFibTree: Fix[TreeF[Int, ?]] => Int =
    cata[Int, TreeF[Int, ?]] { case TipF => 0; case BranchF(_, 0, 0) => 1; case BranchF(_, l, r) => l + r}
